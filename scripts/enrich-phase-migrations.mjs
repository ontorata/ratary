...
const PHASES = [
  ...
  },
  {
    ...
    gateDate: '2026-07-04',
    reason: 'no DDL — `@ratary/sdk`, CLI, MCP server packages; OpenAPI snapshot only',
  ...
  },
  {
    ...
    rollback: '`RATARY_PLATFORM_ENABLED=false` — subscriptions persist; delivery consumer off when flag OFF',
