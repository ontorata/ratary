...
export async function globalIntelligenceRoutes(
  ...
  fastify.get(
    '/intelligence/analytics/workspace-health',
    controller.getWorkspaceHealth.bind(controller),
  );
  fastify.get('/intelligence/analytics/cost', controller.getCost.bind(controller));
  fastify.get(
    '/intelligence/analytics/context-effectiveness',
    controller.getContextEffectiveness.bind(controller),
  );
