...
**Hierarchy:** [AI_BRAIN_CONSTITUTION.md](AI_BRAIN_CONSTITUTION.md) → this policy → individual ADRs → implementation.
...
| Document | Role |
|----------|------|
| [AI_BRAIN_CONSTITUTION.md](AI_BRAIN_CONSTITUTION.md) | Immutable rules |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Structure, layers, extension points |
| [ENGINEERING.md](ENGINEERING.md) | Principal Engineer process & pre-code analysis |
