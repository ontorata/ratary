...
After enabling: ensure production D1 migrations include `code_*` tables; first index should be a small agreed set (knowledge: **docs-ai** `products/ratary/evidence/phase-38-code-memory/`; local fixture: `docs/evidence/phase-38-code-memory/fixture/`).
...
Phases reference: **docs-ai** `products/ratary/roadmap/PHASES-32-34.md`
