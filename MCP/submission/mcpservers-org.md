...
## Long description (if optional field)

Ratary is an open-source AI Brain Platform. The Memory MCP server (`ratary`) gives coding assistants durable, owner-scoped memory across sessions — not just RAG chunks.
