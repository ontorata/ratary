...
4. **Operational gaps** — Cache, analytics, and event bus ports wired with NoOp/default adapters; object storage R2 adapter landed ([ADR-005 Implemented](../../adr/005-content-object-store.md)); content offload consumer deferred to Phase 13.
...
- [ADR-002 Workspace identity model](../../adr/002-workspace-identity-model.md)
- [ADR-004 Repository port types](../../adr/004-repository-port-types.md)
- [ADR-005 Content object store](../../adr/005-content-object-store.md)
