...
**Baseline (Phase 10 gate):** 405 tests · default deploy D1-only unchanged · platform adapters opt-in (ADR-008–017). **Live metrics:** [10-PHASE-STATUS.md](../../core/architecture/10-PHASE-STATUS.md).
...
## Extension tracks (opt-in, post–Phase 6)

Shipped alongside core phases — each gated by env flags; default OFF preserves regression baseline.

| Phase | Name | Status | ADR |
|-------|------|--------|-----|
| **6.6** | **Precision Search Platform** | ✅ Implemented (2026-07-05) | [ADR-060](../../adr/060-precision-search-platform.md) |
| 6.5 | Progressive Retrieval | ✅ Implemented | ADR-024 |
| 8.8 | Inspection Pattern Ledger | ✅ Implemented | ADR-059 |
| 7.1 | Agent Forge | ✅ Workflow | — |

Full index: [phases/README.md](../README.md#phase-index--extension-tracks-opt-in).
