...
| **Baseline tags** | `org-memory-p1-c-complete` · `org-memory-p1-d-complete` · `org-memory-p2-a-complete` · `org-memory-p2-b-complete` |
...
| **Ontory** | How is AI executed? | P2-A kernel + P2-B OpenAI adapter · baselines `org-memory-p2-a-complete` · `org-memory-p2-b-complete` |
