...
**Template:** [workflow/12-TASK-TEMPLATE.md](workflow/12-TASK-TEMPLATE.md) — use for Phase 6 when ADR-001 is Approved.

**Before coding:** [ai-rules/11-AI-RULES.md](ai-rules/11-AI-RULES.md) · [architecture/04-ARCHITECTURE.md](architecture/04-ARCHITECTURE.md) · [workflow/05-WORKFLOW.md](workflow/05-WORKFLOW.md) — complete pre-code analysis per §Pre-implementation analysis.
...
- Follow [.ai/ai-rules/11-AI-RULES.md](.ai/ai-rules/11-AI-RULES.md)
...
| **Documentation** | `.ai/architecture/10-PHASE-STATUS.md` phase row; ADR-003 → Implemented in `adr/README.md` |
| **Final completion report** | Per [.ai/workflow/05-WORKFLOW.md](.ai/workflow/05-WORKFLOW.md) output format + definition of done checklist below |
...
Approve [ADR-001](../../docs/adr/001-multi-source-retrieval.md) → copy [.ai/workflow/12-TASK-TEMPLATE.md](.ai/workflow/12-TASK-TEMPLATE.md) for **Phase 6 Hybrid Retrieval**.

---

## When Phase 5 completes

Copy [.ai/workflow/12-TASK-TEMPLATE.md](.ai/workflow/12-TASK-TEMPLATE.md) → replace this file for **Phase 6 Hybrid Retrieval** (after ADR-001 Approved).
...
- [adr/003-embedding-storage-mvp.md](../../docs/adr/003-embedding-storage-mvp.md)
- [adr/004-repository-port-types.md](../../docs/adr/004-repository-port-types.md)
- [adr/002-workspace-identity-model.md](../../docs/adr/002-workspace-identity-model.md)
