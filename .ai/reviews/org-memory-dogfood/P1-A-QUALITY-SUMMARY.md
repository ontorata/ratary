...
| Task 6 — Internal usage metrics | `6aa8af6` | ✅ | `internal-usage-metrics.md`, `metrics:org-memory` | low (single-org sample) | Task 7 |
...
| Task 8 — Non-regression + G4 remediation | `f331a32` | ✅ | `ci:org-memory-acceptance`, updated recall/trace/metrics/acceptance docs | low | closeout |
...
- [x] Baseline lock + tag decided (`org-memory-p1-a-complete`)
