...
- [ ] [13-AI-DECISION-FRAMEWORK.md](../../decision-framework/13-AI-DECISION-FRAMEWORK.md) — extend vs new module decided
...
- [ ] Implementation follows [01-ENGINEERING-STANDARD.md](../../standards/01-ENGINEERING.md)
- [ ] Canonical module owners respected ([AI_BRAIN_CONSTITUTION.md](../../ai-rules/11-AI-RULES.md))
- [ ] No duplicate services, repositories, or utilities
- [ ] No `*V2` parallel modules
- [ ] Layer boundaries preserved ([04-ARCHITECTURE.md](../../architecture/04-ARCHITECTURE.md))
...
- [ ] [06-TESTING-STANDARD.md](../../standards/06-TESTING.md) — unit, repo, service coverage for changed behavior
...
- [ ] [04-ARCHITECTURE.md](../../architecture/04-ARCHITECTURE.md) extension points used correctly
...
- [ ] [ARCHITECTURE.md](../../architecture/10-PHASE-STATUS.md) updated
