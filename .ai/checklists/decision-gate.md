...
**Purpose:** Pre-code verification. Authoritative rules: [13-AI-DECISION-FRAMEWORK.md](../../decision-framework/13-AI-DECISION-FRAMEWORK.md).
...
- [ ] Structural architecture preserved ([04-ARCHITECTURE.md](../../architecture/04-ARCHITECTURE.md))
