...
Telemetry (ADR-037) produces content-free events. Phase 25 needs an engine that **derives** knowledge/memory quality, search precision, adoption, cost, and latency ΓÇö turning signals into actionable intelligence for teams and enterprise FinOps.

Design: [.ai/phases/25-global-ai-intelligence/DESIGN.md](../../.ai/phases/25-global-ai-intelligence/DESIGN.md) ┬º4, ┬º9.

## Problem

Without analytics, operators cannot measure whether knowledge is effective, whether AI adoption is growing, or where cost/latency concentrate ΓÇö and cannot optimize.
...
Add store adapter + query port ΓåÆ analytics service ΓåÆ REST/MCP report surfaces ΓåÆ Grafana packs. Additive, gated.
...
| L21ΓÇôL30 Learning | Learning policy may read analytics (read-only) |
