...
[assembly: InternalsVisibleTo("ratary_sdk.Test")]
...
namespace ratary_sdk.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is CreateDecisionProvenanceRequest.VerdictEnum createDecisionProvenanceRequestVerdictEnum)
                return CreateDecisionProvenanceRequest.VerdictEnumToJsonValue(createDecisionProvenanceRequestVerdictEnum);
            if (obj is CreateDecisionProvenanceRequest.SandboxOutcomeEnum createDecisionProvenanceRequestSandboxOutcomeEnum)
                return CreateDecisionProvenanceRequest.SandboxOutcomeEnumToJsonValue(createDecisionProvenanceRequestSandboxOutcomeEnum);
            if (obj is CreateGovernanceExceptionRequest.ExceptionClassEnum createGovernanceExceptionRequestExceptionClassEnum)
                return CreateGovernanceExceptionRequest.ExceptionClassEnumToJsonValue(createGovernanceExceptionRequestExceptionClassEnum);
            if (obj is DecisionModelCatalogEntry.StabilityEnum decisionModelCatalogEntryStabilityEnum)
                return DecisionModelCatalogEntry.StabilityEnumToJsonValue(decisionModelCatalogEntryStabilityEnum);
            if (obj is DecisionModelComputedPluginSummary.KindEnum decisionModelComputedPluginSummaryKindEnum)
                return DecisionModelComputedPluginSummary.KindEnumToJsonValue(decisionModelComputedPluginSummaryKindEnum);
            if (obj is DecisionProvenanceRecord.VerdictEnum decisionProvenanceRecordVerdictEnum)
                return DecisionProvenanceRecord.VerdictEnumToJsonValue(decisionProvenanceRecordVerdictEnum);
            if (obj is DecisionProvenanceRecord.SandboxOutcomeEnum decisionProvenanceRecordSandboxOutcomeEnum)
                return DecisionProvenanceRecord.SandboxOutcomeEnumToJsonValue(decisionProvenanceRecordSandboxOutcomeEnum);
            if (obj is GovernanceExceptionRecord.ExceptionClassEnum governanceExceptionRecordExceptionClassEnum)
                return GovernanceExceptionRecord.ExceptionClassEnumToJsonValue(governanceExceptionRecordExceptionClassEnum);
            if (obj is GovernanceExceptionRecord.StatusEnum governanceExceptionRecordStatusEnum)
                return GovernanceExceptionRecord.StatusEnumToJsonValue(governanceExceptionRecordStatusEnum);
            ...
            if (obj is PolicyDenialEvent.PointEnum policyDenialEventPointEnum)
                return PolicyDenialEvent.PointEnumToJsonValue(policyDenialEventPointEnum);
            if (obj is RecommendationRerankMetadata.SandboxOutcomeEnum recommendationRerankMetadataSandboxOutcomeEnum)
                return RecommendationRerankMetadata.SandboxOutcomeEnumToJsonValue(recommendationRerankMetadataSandboxOutcomeEnum);
