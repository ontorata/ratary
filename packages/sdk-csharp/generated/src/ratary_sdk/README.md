...
inputSpec: D:\Apps\ai-brain\packages\openapi\ratary-v1.openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{C40293E8-76D5-4D22-937D-5ED05E2F5DCC}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ICapabilitiesApi>();
            IGetCapabilitiesApiResponse apiResponse = await api.GetCapabilitiesAsync("todo");
