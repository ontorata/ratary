...
class ListGovernanceExceptions200Response(BaseModel):
    """
    ListGovernanceExceptions200Response
    """ # noqa: E501
    exceptions: Optional[List[GovernanceExceptionRecord]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exceptions": [GovernanceExceptionRecord.from_dict(_item) for _item in obj["exceptions"]] if obj.get("exceptions") is not None else None
        })
        return _obj
