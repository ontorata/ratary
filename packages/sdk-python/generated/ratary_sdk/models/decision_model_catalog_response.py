...
class DecisionModelCatalogResponse(BaseModel):
    """
    DecisionModelCatalogResponse
    """ # noqa: E501
    models: List[DecisionModelCatalogEntry]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [DecisionModelCatalogEntry.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
