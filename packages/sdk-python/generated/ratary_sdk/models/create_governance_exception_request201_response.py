...
class CreateGovernanceExceptionRequest201Response(BaseModel):
    """
    CreateGovernanceExceptionRequest201Response
    """ # noqa: E501
    exception: Optional[GovernanceExceptionRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exception": GovernanceExceptionRecord.from_dict(obj["exception"]) if obj.get("exception") is not None else None
        })
        return _obj
