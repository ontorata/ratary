...
class GetPolicyDenialSummary200Response(BaseModel):
    """
    GetPolicyDenialSummary200Response
    """ # noqa: E501
    summary: Optional[PolicyDenialSummary] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": PolicyDenialSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
