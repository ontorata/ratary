...
class RecordDecisionProvenance201Response(BaseModel):
    """
    RecordDecisionProvenance201Response
    """ # noqa: E501
    record: Optional[DecisionProvenanceRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "record": DecisionProvenanceRecord.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
        return _obj
