...
class TestUpdateMemoryRequest(unittest.TestCase):
    """UpdateMemoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMemoryRequest:
        """Test UpdateMemoryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMemoryRequest`
        """
    ...
    def testUpdateMemoryRequest(self):
        """Test UpdateMemoryRequest"""
