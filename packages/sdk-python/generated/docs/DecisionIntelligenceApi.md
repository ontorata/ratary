...
> DecisionModelCatalogResponse list_decision_models()
...
with ratary_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List owner-authorized declarative decision models (PI-P6-D0)
        api_response = api_instance.list_decision_models()
        print("The response of DecisionIntelligenceApi->list_decision_models:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DecisionIntelligenceApi->list_decision_models: %s\n" % e)
```
