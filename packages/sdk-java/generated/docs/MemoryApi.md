...
import org.openapitools.client.api.MemoryApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CreateMemoryRequest createMemoryRequest = new CreateMemoryRequest(); // CreateMemoryRequest | 
    try {
      apiInstance.createMemory(createMemoryRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling MemoryApi#createMemory");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MemoryApi#deleteMemory");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MemoryApi#getMemory");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MemoryApi#listMemories");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="updateMemory"></a>
# **updateMemory**
> updateMemory(id, updateMemoryRequest)
...
public class Example {
  public static void main(String[] args) {
    ...
    MemoryApi apiInstance = new MemoryApi(defaultClient);
    UUID id = UUID.randomUUID(); // UUID | 
    UpdateMemoryRequest updateMemoryRequest = new UpdateMemoryRequest(); // UpdateMemoryRequest | 
    try {
      apiInstance.updateMemory(id, updateMemoryRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling MemoryApi#updateMemory");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
